...
#define cmdSetTorrent   0x0100	// передача раздачи на сервер
#define cmdGetTorrent	0x0101  // запрос описания файла для загрузки
...
#define cmdEndSession   0x0204  // закрыть сеанс
...
const QString cmdEgettorrent="gettorrent";

// коннекты
const QString cmdEchat    ="chat";
const QString cmdEmessage ="message";
const QString cmdEaudio   ="audio";
const QString cmdEvideo   ="video";
const QString cmdEvideo_  ="video-";
const QString cmdEfilechat="filechat";
